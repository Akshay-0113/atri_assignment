...
class Atri:
	...
	def menu(self, new_state):
		...
		global default_state
		self._menu = Button(new_state, default_state["menu"])
	...
	def page(self, new_state):
		...
		global default_state
		self._page = Button(new_state, default_state["page"])
	...
	def cart(self, new_state):
		...
		global default_state
		self._cart = Button(new_state, default_state["cart"])
